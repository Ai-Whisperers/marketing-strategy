# Prompt creativo — `dayah-litworks` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-dayah-litworks-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-dayah-litworks-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/s/es/dayah-litworks |
| Slogan rubro | Tu expertise merece un dominio .com.py |
| Colores acento | Navy #1E293B, teal #0D9488 | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Tu portfolio en .com.py

**Sub:** Proyectos · Contacto · 48h
...
Rubro / demo:  — URL demo: https://paragu-ai.com/s/es/dayah-litworks

Paleta: fondo sobrio; acentos del rubro: Navy #1E293B, teal #0D9488 |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Tu portfolio en .com.py
SUB: Proyectos · Contacto · 48h

Slogan de contexto (opcional, pequeño): Tu expertise merece un dominio .com.py
...
3. Guardar como **`../../assets/creativos/vertical-dayah-litworks-social-1080.png`** (carpeta única de creativos).
