# Prompt creativo — `granja-cabral` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-granja-cabral-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-granja-cabral-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/s/es/granja-cabral |
| Slogan rubro | Del campo a la web. |
| Colores acento | Verde #15803D, amarillo huevo | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Del campo a la web en 48h

**Sub:** Fresco · Huevos · WhatsApp
...
Rubro / demo:  — URL demo: https://paragu-ai.com/s/es/granja-cabral

Paleta: fondo sobrio; acentos del rubro: Verde #15803D, amarillo huevo |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Del campo a la web en 48h
SUB: Fresco · Huevos · WhatsApp

Slogan de contexto (opcional, pequeño): Del campo a la web.
...
3. Guardar como **`../../assets/creativos/vertical-granja-cabral-social-1080.png`** (carpeta única de creativos).
