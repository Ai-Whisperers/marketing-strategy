# Prompt creativo — `studio-belleza` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-studio-belleza-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-studio-belleza-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/studio-belleza |
| Slogan rubro | Estilo y confianza en cada clic. |
| Colores acento | Rosa nude, crema #FFFBF7 | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Belleza profesional online en 48h

**Sub:** Servicios · Agenda · ubicación
...
Rubro / demo:  — URL demo: https://paragu-ai.com/studio-belleza

Paleta: fondo sobrio; acentos del rubro: Rosa nude, crema #FFFBF7 |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Belleza profesional online en 48h
SUB: Servicios · Agenda · ubicación

Slogan de contexto (opcional, pequeño): Estilo y confianza en cada clic.
...
3. Guardar como **`../../assets/creativos/vertical-studio-belleza-social-1080.png`** (carpeta única de creativos).
