# Prompt creativo — `gymfit-py` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-gymfit-py-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-gymfit-py-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/gymfit-py |
| Slogan rubro | Tu gym online. Matrículas en WhatsApp. |
| Colores acento | Verde #22C55E, negro #18181B | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Tu gym online en 48h

**Sub:** Planes · Horarios · WhatsApp
...
Rubro / demo:  — URL demo: https://paragu-ai.com/gymfit-py

Paleta: fondo sobrio; acentos del rubro: Verde #22C55E, negro #18181B |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Tu gym online en 48h
SUB: Planes · Horarios · WhatsApp

Slogan de contexto (opcional, pequeño): Tu gym online. Matrículas en WhatsApp.
...
3. Guardar como **`../../assets/creativos/vertical-gymfit-py-social-1080.png`** (carpeta única de creativos).
