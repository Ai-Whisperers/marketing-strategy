# Prompt creativo — `nexa-paraguay` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-nexa-paraguay-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-nexa-paraguay-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/s/es/nexa-paraguay |
| Slogan rubro | Paraguay te espera. Tu web también. |
| Colores acento | Azul profundo #1E3A5F, blanco | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Reubicación con web profesional

**Sub:** 4 idiomas · Confianza · 48h
...
Rubro / demo:  — URL demo: https://paragu-ai.com/s/es/nexa-paraguay

Paleta: fondo sobrio; acentos del rubro: Azul profundo #1E3A5F, blanco |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Reubicación con web profesional
SUB: 4 idiomas · Confianza · 48h

Slogan de contexto (opcional, pequeño): Paraguay te espera. Tu web también.
...
3. Guardar como **`../../assets/creativos/vertical-nexa-paraguay-social-1080.png`** (carpeta única de creativos).
