# Prompt creativo — `barberia-clasica` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-barberia-clasica-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-barberia-clasica-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/barberia-clasica |
| Slogan rubro | Barbería de verdad. Web de verdad. |
| Colores acento | Negro #1C1917, cobre #B87333 | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Barbería online en 48h

**Sub:** Cortes · Reservas · WhatsApp
...
Rubro / demo:  — URL demo: https://paragu-ai.com/barberia-clasica

Paleta: fondo sobrio; acentos del rubro: Negro #1C1917, cobre #B87333 |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Barbería online en 48h
SUB: Cortes · Reservas · WhatsApp

Slogan de contexto (opcional, pequeño): Barbería de verdad. Web de verdad.
...
3. Guardar como **`../../assets/creativos/vertical-barberia-clasica-social-1080.png`** (carpeta única de creativos).
