# Prompt creativo — `depilacion-perfecta` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-depilacion-perfecta-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-depilacion-perfecta-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/depilacion-perfecta |
| Slogan rubro | Suave, profesional, encontrable. |
| Colores acento | Lavanda, blanco, rosa pastel | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Depilación profesional online

**Sub:** Suave · Higiene · Reservá
...
Rubro / demo:  — URL demo: https://paragu-ai.com/depilacion-perfecta

Paleta: fondo sobrio; acentos del rubro: Lavanda, blanco, rosa pastel |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Depilación profesional online
SUB: Suave · Higiene · Reservá

Slogan de contexto (opcional, pequeño): Suave, profesional, encontrable.
...
3. Guardar como **`../../assets/creativos/vertical-depilacion-perfecta-social-1080.png`** (carpeta única de creativos).
