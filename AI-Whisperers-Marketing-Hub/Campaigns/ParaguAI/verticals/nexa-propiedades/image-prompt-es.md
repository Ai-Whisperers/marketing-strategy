# Prompt creativo — `nexa-propiedades` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-nexa-propiedades-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-nexa-propiedades-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/s/es/nexa-propiedades |
| Slogan rubro | Tu inmobiliaria, encontrable online. |
| Colores acento | Azul #1E40AF, dorado #CA8A04 | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Propiedades profesionales online

**Sub:** Ventas · Alquiler · Maps
...
Marca: ParaguAI (nombre exacto). Incluí el logo oficial de ParaguAI (referencia: archivo paraguai-logo.png) y en el pie el texto paragu-ai.com en tipografía legible.

Rubro / demo:  — URL demo: https://paragu-ai.com/s/es/nexa-propiedades

Paleta: fondo sobrio; acentos del rubro: Azul #1E40AF, dorado #CA8A04 |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Propiedades profesionales online
SUB: Ventas · Alquiler · Maps

Slogan de contexto (opcional, pequeño): Tu inmobiliaria, encontrable online.

Texto visible: solo términos neutros para visibilidad (online, página web, internet). Ninguna marca de buscadores o mapas de terceros en el diseño.

Composición: headline grande arriba o al centro, sub debajo, logo ParaguAI en esquina inferior o superior con buen margen, dominio paragu-ai.com al pie.
```

## Checklist pre-generación (corregir aquí antes de IA)
...
3. Guardar como **`../../assets/creativos/vertical-nexa-propiedades-social-1080.png`** (carpeta única de creativos).
