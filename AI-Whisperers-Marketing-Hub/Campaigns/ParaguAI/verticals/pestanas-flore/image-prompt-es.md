# Prompt creativo — `pestanas-flore` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-pestanas-flore-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-pestanas-flore-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/pestanas-flore |
| Slogan rubro | Citas llenas. Diseños que venden solos. |
| Colores acento | Lavanda, malva, dorado suave | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Pestañas que venden online

**Sub:** Volumen · Citas · WhatsApp
...
Rubro / demo:  — URL demo: https://paragu-ai.com/pestanas-flore

Paleta: fondo sobrio; acentos del rubro: Lavanda, malva, dorado suave |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Pestañas que venden online
SUB: Volumen · Citas · WhatsApp

Slogan de contexto (opcional, pequeño): Citas llenas. Diseños que venden solos.
...
3. Guardar como **`../../assets/creativos/vertical-pestanas-flore-social-1080.png`** (carpeta única de creativos).
