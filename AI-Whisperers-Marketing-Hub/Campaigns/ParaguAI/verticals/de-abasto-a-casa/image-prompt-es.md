# Prompt creativo — `de-abasto-a-casa` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-de-abasto-a-casa-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-de-abasto-a-casa-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/de-abasto-a-casa |
| Slogan rubro | De la cocina a su celular en un clic. |
| Colores acento | Rojo #DC2626, crema #FFFBEB | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Pedidos por WhatsApp desde tu web
...
Rubro / demo:  — URL demo: https://paragu-ai.com/de-abasto-a-casa

Paleta: fondo sobrio; acentos del rubro: Rojo #DC2626, crema #FFFBEB |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Pedidos por WhatsApp desde tu web
SUB: Menú · Fresco · 48h

Slogan de contexto (opcional, pequeño): De la cocina a su celular en un clic.
...
3. Guardar como **`../../assets/creativos/vertical-de-abasto-a-casa-social-1080.png`** (carpeta única de creativos).
