# Prompt creativo — `spa-serenidad` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-spa-serenidad-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-spa-serenidad-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/spa-serenidad |
...
Rubro / demo:  — URL demo: https://paragu-ai.com/spa-serenidad

Paleta: fondo sobrio; acentos del rubro: Salvia #6B9080, beige #E7E5E4 |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Tu spa online en 48h
SUB: Bienestar · Reservas · Calma

Slogan de contexto (opcional, pequeño): Serenidad online. Reservas sin estrés.
...
3. Guardar como **`../../assets/creativos/vertical-spa-serenidad-social-1080.png`** (carpeta única de creativos).
