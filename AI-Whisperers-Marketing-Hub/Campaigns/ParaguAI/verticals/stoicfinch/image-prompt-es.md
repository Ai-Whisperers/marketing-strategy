# Prompt creativo — `stoicfinch` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-stoicfinch-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-stoicfinch-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/s/en/stoicfinch |
| Slogan rubro | Te juzgan por tu web antes del primer mail. |
| Colores acento | Slate #334155, teal #0D9488 | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Consultoría que cierra con tu web

**Sub:** Casos · Datos · Contacto
...
Rubro / demo:  — URL demo: https://paragu-ai.com/s/en/stoicfinch

Paleta: fondo sobrio; acentos del rubro: Slate #334155, teal #0D9488 |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Consultoría que cierra con tu web
SUB: Casos · Datos · Contacto

Slogan de contexto (opcional, pequeño): Te juzgan por tu web antes del primer mail.
...
3. Guardar como **`../../assets/creativos/vertical-stoicfinch-social-1080.png`** (carpeta única de creativos).
