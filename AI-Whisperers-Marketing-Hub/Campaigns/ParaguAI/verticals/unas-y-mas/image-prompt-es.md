# Prompt creativo — `unas-y-mas` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-unas-y-mas-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-unas-y-mas-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/unas-y-mas |
| Slogan rubro | Tu arte en uñas merece más que un story. |
| Colores acento | Lavanda #A78BFA, rosa pastel | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Tu nail studio online

**Sub:** Diseños · Citas · WhatsApp
...
Rubro / demo:  — URL demo: https://paragu-ai.com/unas-y-mas

Paleta: fondo sobrio; acentos del rubro: Lavanda #A78BFA, rosa pastel |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Tu nail studio online
SUB: Diseños · Citas · WhatsApp

Slogan de contexto (opcional, pequeño): Tu arte en uñas merece más que un story.
...
3. Guardar como **`../../assets/creativos/vertical-unas-y-mas-social-1080.png`** (carpeta única de creativos).
