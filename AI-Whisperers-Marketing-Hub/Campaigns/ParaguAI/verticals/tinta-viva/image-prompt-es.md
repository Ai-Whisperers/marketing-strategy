# Prompt creativo — `tinta-viva` (revisar antes de generar)

> **Flujo:** completá y corregí este documento → marcá el checklist pre-generación → recién ahí generá `vertical-tinta-viva-social-1080.png` en [assets/creativos](../../assets/creativos/README.md).

## Especificaciones fijas

| Campo | Valor |
|-------|--------|
| Salida | `../../assets/creativos/vertical-tinta-viva-social-1080.png` (1080×1080 px) |
...
| Demo | https://paragu-ai.com/tinta-viva |
| Slogan rubro | Tu tinta. Tu sitio. Tu agenda. |
| Colores acento | Negro #0A0A0A, turquesa #2DD4BF | |

## Texto en imagen (aprobar literal; editá acá si cambiás el creativo)

**Headline:** Tu estudio online

**Sub:** Portfolio · Sesiones · WhatsApp
...
Rubro / demo:  — URL demo: https://paragu-ai.com/tinta-viva

Paleta: fondo sobrio; acentos del rubro: Negro #0A0A0A, turquesa #2DD4BF |. No reinventes el logotipo ParaguAI: usá el lockup oficial o compositá el PNG de marca después.

Texto principal en español (máx. 2 líneas cortas):
HEADLINE: Tu estudio online
SUB: Portfolio · Sesiones · WhatsApp

Slogan de contexto (opcional, pequeño): Tu tinta. Tu sitio. Tu agenda.
...
3. Guardar como **`../../assets/creativos/vertical-tinta-viva-social-1080.png`** (carpeta única de creativos).
