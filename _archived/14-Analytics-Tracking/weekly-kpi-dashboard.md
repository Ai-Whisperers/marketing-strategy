...
> Track progress every week to stay on course
...
|--------|--------|--------|-----------|-------|
| Website visitors | 250 | | | |
| LinkedIn profile views | 500 | | | |
| LinkedIn post impressions | 5,000 | | | |
| LinkedIn followers (new) | 50 | | | |
| Email list size (total) | — | | | |
...
| Post/Content | Date | Platform | Impressions | Engagement | Leads |
|--------------|------|----------|-------------|------------|-------|
| | | | | | |
| | | | | | |
| | | | | | |
...
### New Leads This Week
| Name | Company | Source | Status | Next Action |
|------|---------|--------|--------|-------------|
| | | | | |
| | | | | |
| | | | | |
...
| Connection requests accepted | 15 | |
| Cold emails sent | 25 | |
| Cold email replies | 3 | |
| Follow-ups sent | 20 | |
